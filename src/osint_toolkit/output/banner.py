...
def print_banner(console: Console | None = None) -> None:
    ...
    ascii_art = pyfiglet.figlet_format("OSINT", font="ansi_shadow", width=terminal_width)
    lines = [line for line in ascii_art.splitlines() if line.strip()]

    if not lines:
        console.print("[bold cyan]OSINT Toolkit[/bold cyan]")
        return
    ...
    console.print(
        "  [bold cyan]OSINT Toolkit[/bold cyan] [dim]|[/dim] "
